...
- Scanner 존재의 역할
    * Binder가 HTMLElement의 dataSet property를 Scan한다.  
    * Scanner로 부터 Binder를 알게 된다.   
    * 결국 Binder는 HTMLElement를 모르게 된다.   
- Scanner를 만드는 이유 
...
* MVVM Pattern 도식화
![](2회/mvvmPattern도식화_Scanner표시.png)
